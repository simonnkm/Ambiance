...
Projects/Common/BLE/Modules/%.o: ../Projects/Common/BLE/Modules/%.s Projects/Common/BLE/Modules/subdir.mk
	arm-none-eabi-gcc -mcpu=cortex-m0plus -g3 -DDEBUG -c -I"C:/Users/simon/Downloads/INTERNPROJECT/Ambiance-main/Ambiance-main/WPSSource/WildlifeSource/Drivers/BSP/STM32WB0x-nucleo" -x assembler-with-cpp -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@" "$<"
